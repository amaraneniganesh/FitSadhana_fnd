    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-[#0A0A0A]">
      ...
      >
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-500 text-sm">Join FitnessAI and start your transformation.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            ...
            <div className="relative">
              ...
              <input 
                type="text" 
                className="w-full bg-secondary border border-gray-800 rounded-xl py-3 pl-10 pr-4 text-white focus:outline-none focus:border-purple-500 transition-colors"
                placeholder="johndoe"
